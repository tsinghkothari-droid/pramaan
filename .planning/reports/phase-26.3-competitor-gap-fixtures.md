...
| --- | --- | --- | --- | --- |
| `CG-001` weakened assertion | AI PR reviewer | Passing tests can hide a weaker assertion. | Failed oracle receipt. | fail |
...
| `CG-004` hallucinated import | AI PR reviewer | Plausible code depends on nonexistent API. | Static receipt with hallucination risk. | fail |
...
> Pramaan empirically outperforms every named AI reviewer or quality tool.
