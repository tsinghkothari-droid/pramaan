...
Phases 1-17 are implemented and validated as the broad Serious v1 execution
path so far. Phases
...
- Phase 32.75 uses a separate small verifier-abuse fixture runner first, while
  Phase 40 still owns larger executable exploit fixtures.
...
| 2026-05-21 | Split Phase 27.2 and Phase 28.2 from PASS_WITH_RISKS residuals. | Full compiler AST and production property/fuzz sandboxing are too large to close honestly in one pass, so they now have concrete gap-closure phase plans and acceptance criteria. |
...
| 2026-05-21 | Completed Phase 26.2 competitive benchmark. | `docs/competitive-benchmark.md` now narrows Pramaan's differentiation against adjacent review assistants, quality aggregators, test-generation systems, mutation/property tools, and supply-chain attestation primitives without claiming superiority before executable gap fixtures. |
